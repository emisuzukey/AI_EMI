...
public class Q1Inference {

    public static void main(String[] args) throws Exception {

        MultiLayerNetwork model = ModelSerializer.restoreMultiLayerNetwork("D:\\BACKUPDATA\\AI_SKYMIND\\midterm\\deposit.zip", true);

        File testFilePath = new ClassPathResource("datavec/test.csv").getFile();
        ...
        NormalizerMinMaxScaler scaler = normalizerSerializer.restore("D:\\BACKUPDATA\\AI_SKYMIND\\midterm\\normalizer.zip");
