...
public class SignUNET {
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(SignUNET.class);
...
//        Initialize the user interface backend
        ...
        // STEP 3: Load data into RecordReaderDataSetIterator
        DataIterator.setup(batchSize, trainPerc, getImageTransform());

        //Create iterators
        RecordReaderDataSetIterator imageDataSetTrain = DataIterator.trainIterator();
        RecordReaderDataSetIterator imageDataSetVal = DataIterator.valIterator();
