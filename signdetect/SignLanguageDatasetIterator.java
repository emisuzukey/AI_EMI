...
public class SignLanguageDatasetIterator extends RecordReaderDataSetIterator {

    private static final Logger log = org.slf4j.LoggerFactory.getLogger(SignLanguageDatasetIterator.class);
    ...
    public SignLanguageDatasetIterator(RecordReader recordReader, int batchSize) {
